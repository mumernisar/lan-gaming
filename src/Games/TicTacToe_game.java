...
public class TicTacToe {
    ...
    public static void startTicTacToe(Socket socket, BufferedReader input, PrintWriter output, HashMap<String, String> gameState) {
        TicTacToe.socket = socket;
        TicTacToe.input = input;
        TicTacToe.output = output;
        ...
        while (winner == null) {
            ...
            if (board[numInput - 1].equals(String.valueOf(numInput))) {
                ...
                printBoard(output);
                winner = checkWinner();
                sendGameState(); // Send updated game state to the server
            } else {
    ...
    static void sendGameState() {
        ...
        for (String cell : board) {
            gameStateStr.append(cell);
        }
        output.println(gameStateStr.toString() + " " + turn);
    }
}
